  ...
  return (
    <div className="w-[65%] mx-auto md:w-full xl:w-[80%] sm:w-full sm:px-5">
      ...
      <motion.div
        ...
        whileInView="visible"
        variants={variant}
        className="flex items-start sm:flex-col justify-between mt-10 sm:mt-10 gap-x-14"
      >
        ...
        <div className="flex-1 sm:w-full mt-3 sm:mt-10">
          ...
          <p className="text-[12px] mt-4 mb-2 text-gray-400">
            I am a fresh graduate from a vocational high school Kristen Immanuel
            Pontianak, West Kalimantan. I majored in computer and network
            engineering (TKJ)
          </p>
          <p className="text-[12px] text-gray-400">
            Now I'm actively looking for a job as a remote fullstack web
            developer. I have internship experience as a web developer for 2
            months from November to the end of December 2022.
          </p>
          ...
          <Link href="resume/Wendi-CurriculumVitae.pdf" download="wendi-cv">
            <button className="text-white font-semibold text-[13px] bg-blue-400 py-2 px-4 rounded-md mt-7">
              Download CV
            </button>
          </Link>
        </div>
